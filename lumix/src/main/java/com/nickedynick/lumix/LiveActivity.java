...
public class LiveActivity extends Activity
    ...
    public void onNavigationDrawerItemSelected(int position) {
        Fragment fragment = GalleryActivity.GalleryFragment.newInstance(position + 1);
    ...
    public static class LiveFragment extends Fragment {
        ...
        public void onAttach(Activity activity) {
            ...
            ((LiveActivity) activity).onSectionAttached(
                    getArguments().getInt(ARG_SECTION_NUMBER));
            // ToDo: java.lang.ClassCastException: com.nickedynick.lumix.GalleryActivity cannot be cast to com.nickedynick.lumix.LiveActivity at com.nickedynick.lumix.LiveActivity$LiveFragment.onAttach(LiveActivity.java:153)
        }
    }
